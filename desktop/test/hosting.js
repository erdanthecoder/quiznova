...
(async () => {
  ...
  ok('every mode is offered', cards === 6, `${cards} modes`);
  ...
  ok('each mode card draws something', modeArt.length === 6 && modeArt.every(n => n > 200),
  ...
  ok('the main page offers the modes too', hubModes === 6, `${hubModes} modes`);
  if (hubModes) {
